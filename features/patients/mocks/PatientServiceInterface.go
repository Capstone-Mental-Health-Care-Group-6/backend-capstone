...
// PatientServiceInterface is an autogenerated mock type for the PatientServiceInterface type
type PatientServiceInterface struct {
	mock.Mock
}
...
// GetPatient provides a mock function with given fields: id
func (_m *PatientServiceInterface) GetPatient(id int) (patients.Patientdetail, error) {
	ret := _m.Called(id)
...
// GetPatients provides a mock function with given fields: status, name
func (_m *PatientServiceInterface) GetPatients(status string, name string) ([]patients.Patientdetail, error) {
...
func (_m *PatientServiceInterface) LoginPatient(email string, password string) (*patients.PatientCredential, error) {
	ret := _m.Called(email, password)

	var r0 *patients.PatientCredential
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) (*patients.PatientCredential, error)); ok {
		return rf(email, password)
	}
	if rf, ok := ret.Get(0).(func(string, string) *patients.PatientCredential); ok {
		r0 = rf(email, password)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*patients.PatientCredential)
		}
	}
...
func (_m *PatientServiceInterface) PatientDashboard() (patients.PatientDashboard, error) {
	ret := _m.Called()
...
// PhotoUpload provides a mock function with given fields: newData
func (_m *PatientServiceInterface) PhotoUpload(newData patients.AvatarPhoto) (string, error) {
	ret := _m.Called(newData)

	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(patients.AvatarPhoto) (string, error)); ok {
		return rf(newData)
	}
	if rf, ok := ret.Get(0).(func(patients.AvatarPhoto) string); ok {
		r0 = rf(newData)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(patients.AvatarPhoto) error); ok {
		r1 = rf(newData)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PatientServiceInterface) UpdatePassword(id int, newData patients.UpdatePassword) (bool, error) {
...
// UpdatePatient provides a mock function with given fields: id, newData
func (_m *PatientServiceInterface) UpdatePatient(id int, newData patients.UpdateProfile) (bool, error) {
	ret := _m.Called(id, newData)
...
func (_m *PatientServiceInterface) UpdateStatus(id int, newData patients.UpdateStatus) (bool, error) {
	ret := _m.Called(id, newData)
...
// NewPatientServiceInterface creates a new instance of PatientServiceInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewPatientServiceInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *PatientServiceInterface {
	mock := &PatientServiceInterface{}
	mock.Mock.Test(t)
